...
#define WIFI_SETGETOPTION_IP_SUBNET_MASK_EN 0
...
#define WIFI_SETGETOPTION_IP_GATEWAY_EN 0
...
#define WIFI_SETGETOPTION_IP_DNS1_EN    0
...
#define WIFI_SOCKETGETHOSTBYNAME_EN     0
// <q> WIFI_Ping
