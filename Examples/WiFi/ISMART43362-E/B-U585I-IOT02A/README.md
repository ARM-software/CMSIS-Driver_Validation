# Inventek ISM43362 WiFi CMSIS-Driver Validation Example

This folder provides a **ready-to-use CMSIS-Driver Validation application** for testing and verifying the **Inventek ISM43362 WiFi driver** with [**Inventek ISM43362-M3G-L44-E eS-WiFi Shield**](https://www.inventeksys.com/ism4336-m3g-l44-e-embedded-serial-to-wifi-module/) connected to the STMicroelectronics [**B-U585I-IOT02A**](https://www.st.com/en/evaluation-tools/B-U585I-IOT02A.html) development board.
...
- [Inventek ISMART43362-E WiFi Shield](https://www.inventeksys.com/ismart43362-arduino-shields-wi-fi/) with **firmware v6.2.1.7**
- Personal Computer running Microsoft Windows
- **USB-A to micro USB** cable

> **Note:** For module firmware update procedure consult the following [documentation](https://arm-software.github.io/CMSIS-Driver/latest/driver_WiFi.html#driver_ISM43362).
...
2. Connect **Inventek ISMART43362-E WiFi Shield** to the **Arduino** connector on the **B-U585I-IOT02A** board.
...
```
CMSIS-Driver_Validation v3.1.0 CMSIS-Driver WiFi Test Report   Oct 17 2025   12:20:41 
...
TEST 29: WIFI_SocketGetHostByName         NOT EXECUTED
...
TEST 37: WIFI_Downstream_Rate             
  DV_WIFI.c (9267): [INFO] Speed 292 KB/s
                                          PASSED
TEST 38: WIFI_Upstream_Rate               
  DV_WIFI.c (9335): [INFO] Speed 277 KB/s
                                          PASSED

Test Summary: 38 Tests, 35 Passed, 0 Failed.
Test Result: PASSED
```
