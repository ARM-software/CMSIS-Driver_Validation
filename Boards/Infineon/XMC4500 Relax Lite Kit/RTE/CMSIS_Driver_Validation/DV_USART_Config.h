...
#define USART_TC_INIT_UNINIT_EN         0
#define USART_TC_POWER_CONTROL_EN       0
...
#define USART_TC_PARITY_EVEN_EN         0
#define USART_TC_PARITY_ODD_EN          0
#define USART_TG_STOP_BITS_EN           1
#define USART_TC_STOP_BITS_1_EN         1
#define USART_TC_STOP_BITS_2_EN         0
...
#define USART_TG_OTHER_EN               0
#define USART_TC_NUMBER_OF_ITEMS_EN     0
#define USART_TC_GET_TX_COUNT_EN        0
#define USART_TC_GET_RX_COUNT_EN        0
#define USART_TC_GET_TX_RX_COUNT_EN     0
#define USART_TC_ABORT_SEND_EN          0
#define USART_TC_ABORT_RECEIVE_EN       0
#define USART_TC_ABORT_TRANSFER_EN      0
#define USART_TC_TX_BREAK_EN            0
