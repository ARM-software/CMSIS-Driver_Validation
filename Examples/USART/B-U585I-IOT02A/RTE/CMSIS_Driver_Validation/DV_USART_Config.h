...
#define USART_TC_DATA_BITS_9_EN         1
...
#define USART_TG_FLOW_CTRL_EN           1
#define USART_TC_FLOW_CTRL_NONE_EN      1
#define USART_TC_FLOW_CTRL_RTS_EN       0
#define USART_TC_FLOW_CTRL_CTS_EN       0
#define USART_TC_FLOW_CTRL_RTS_CTS_EN   0
...
#define USART_TG_EVENT_EN               1
#define USART_TC_TX_UNDERFLOW_EN        0
#define USART_TC_RX_OVERFLOW_EN         0
#define USART_TC_RX_TIMEOUT_EN          0
#define USART_TC_RX_BREAK_EN            0
